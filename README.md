...
一个 VSCode 扩展，连接郊狼主机（DG-LAB），根据AI代码质量评分自动触发电击反馈。

该扩展为 [Chobits AI Code Checker](https://marketplace.visualstudio.com/items?itemName=MRoldL001.chobits-ai-code-checker) 的示例子扩展，展示了如何调用上文所提扩展的开发者 API 
